  ...
  constructor({ editor, element, view, tippyOptions = {}, updateDelay = 250, shouldShow }) {
    ...
    this.updateHandler = (view2, selectionChanged, docChanged, oldState) => {
      ...
      (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
        getReferenceClientRect: ((_c3 = this.tippyOptions) === null || _c3 === void 0 ? void 0 : _c3.getReferenceClientRect) || (() => {
...
function requireUseSyncExternalStoreShim_development() {
  ...
  if (true) {
    (function() {
      ...
      var useState4 = React$1.useState, useEffect4 = React$1.useEffect, useLayoutEffect2 = React$1.useLayoutEffect, useDebugValue2 = React$1.useDebugValue;
...
function requireWithSelector_development() {
  ...
  if (true) {
    (function() {
      ...
      var useRef2 = React$1.useRef, useEffect4 = React$1.useEffect, useMemo = React$1.useMemo, useDebugValue2 = React$1.useDebugValue;
...
var StarterKit = Extension.create({
  name: "starterKit",
  addExtensions() {
    var _a, _b, _c3, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s3, _t;
    const extensions = [];
    ...
    if (this.options.bulletList !== false) {
      extensions.push(BulletList.configure((_c3 = this.options) === null || _c3 === void 0 ? void 0 : _c3.bulletList));
    }
    ...
    if (this.options.strike !== false) {
      extensions.push(Strike.configure((_s3 = this.options) === null || _s3 === void 0 ? void 0 : _s3.strike));
    }
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\ai-suggestions.tsx"' + id);
  };
...
function AiSuggestions({
  ...
  const [score] = React2.useState(87);
  const [openSuggestion, setOpenSuggestion] = React2.useState(null);
    ...
    const timer = setTimeout(() => {
      const newSuggestions = [{
        ...
        content: {
          ...
          highlights: ["Add real-world case studies", "Include statistical data", "Share relevant experiences", "Reference expert opinions"]
        }
      }, {
        id: "2",
        type: "insight",
        ...
        content: {
          ...
          highlights: ["Start with a surprising statistic", "Open with a thought-provoking question", "Begin with a relevant anecdote", "Present a compelling problem"]
        }
      }, {
        id: "3",
        type: "enhancement",
        ...
        content: {
          ...
          highlights: ["Keep paragraphs to 3-4 sentences", "Use bullet points strategically", "Add clear subheadings", "Increase white space"]
        }
      }, {
        id: "4",
        type: "improvement",
        ...
        content: {
          ...
          highlights: ["Add transitional phrases", "Connect ideas explicitly", "Summarize before new topics", "Use logical bridges"]
        }
      }, {
        id: "5",
        type: "insight",
        ...
        content: {
          ...
          highlights: ["Cite recent studies", "Include expert quotes", "Add industry statistics", "Reference peer-reviewed papers"]
        }
      }];
  ...
  if (loading) {
    return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { initial: {
      ...
      opacity: 1,
      y: 0
    }, className: "rounded-lg bg-muted/50 p-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Bot, { className: "h-4 w-4 animate-pulse" }, void 0, false, {
        fileName: "app/components/ai-suggestions.tsx",
        lineNumber: 121,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: "Analyzing content..." }, void 0, false, {
        fileName: "app/components/ai-suggestions.tsx",
        lineNumber: 122,
        columnNumber: 11
      }, this)
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ScrollArea, { className: "h-[calc(100vh-12rem)]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { className: "space-y-4 pr-4", initial: {
    opacity: 0
  }, animate: {
    opacity: 1
  }, transition: {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { initial: {
      ...
      duration: 0.4,
      delay: 0.1
    }, className: "rounded-lg bg-muted/50 p-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.p, { className: "text-2xl font-bold tracking-tight", initial: {
        opacity: 0
      }, animate: {
        opacity: 1
      }, transition: {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { className: cn("flex h-14 w-14 items-center justify-center rounded-full transition-colors", gradeStyle), initial: {
        scale: 0
      }, animate: {
        scale: 1
      }, transition: {
        ...
        damping: 15,
        delay: 0.4
      }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-2xl font-bold", children: letterGrade }, void 0, false, {
        fileName: "app/components/ai-suggestions.tsx",
        lineNumber: 168,
        columnNumber: 15
      }, this) }, void 0, false, {
    ...
    suggestions.map((suggestion, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { initial: {
      opacity: 0,
      y: 20
    }, animate: {
      opacity: 1,
      ...
      duration: 0.3,
      delay: 0.1 * (index + 2)
    }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Collapsible, { open: openSuggestion === suggestion.id, onOpenChange: (open) => setOpenSuggestion(open ? suggestion.id : null), children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "rounded-lg bg-muted/50", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CollapsibleTrigger, { className: "flex w-full items-center justify-between p-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { whileHover: {
            scale: 1.1
          }, whileTap: {
            scale: 0.95
          }, children: [
            suggestion.type === "improvement" && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Sparkles, { className: "h-4 w-4 text-blue-500" }, void 0, false, {
              fileName: "app/components/ai-suggestions.tsx",
              lineNumber: 192,
              columnNumber: 61
            }, this),
            suggestion.type === "insight" && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Lightbulb, { className: "h-4 w-4 text-amber-500" }, void 0, false, {
              fileName: "app/components/ai-suggestions.tsx",
              lineNumber: 193,
              columnNumber: 57
            }, this),
            suggestion.type === "enhancement" && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Bot, { className: "h-4 w-4 text-emerald-500" }, void 0, false, {
              fileName: "app/components/ai-suggestions.tsx",
              lineNumber: 194,
              columnNumber: 61
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-sm font-medium", children: suggestion.title }, void 0, false, {
            fileName: "app/components/ai-suggestions.tsx",
            lineNumber: 196,
            columnNumber: 21
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { animate: {
          ...
          duration: 0.2
        }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ChevronDown, { className: "h-4 w-4 text-muted-foreground" }, void 0, false, {
          fileName: "app/components/ai-suggestions.tsx",
          lineNumber: 205,
          columnNumber: 21
        }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CollapsibleContent, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(AnimatePresence, { children: openSuggestion === suggestion.id && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { initial: {
        height: 0,
        opacity: 0
      }, animate: {
        height: "auto",
        ...
        duration: 0.2
      }, className: "border-t border-border/50", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-sm text-muted-foreground mb-3", children: suggestion.content.summary }, void 0, false, {
          fileName: "app/components/ai-suggestions.tsx",
          lineNumber: 223,
          columnNumber: 27
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "space-y-2", children: suggestion.content.highlights.map((highlight, i) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center gap-2 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-1.5 w-1.5 rounded-full bg-primary/50" }, void 0, false, {
            fileName: "app/components/ai-suggestions.tsx",
            lineNumber: 228,
            columnNumber: 33
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-medium text-primary", children: highlight }, void 0, false, {
            fileName: "app/components/ai-suggestions.tsx",
            lineNumber: 229,
            columnNumber: 33
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { className: "mt-4 flex gap-2", initial: {
          opacity: 0,
          y: 10
        }, animate: {
          opacity: 1,
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { size: "sm", className: "w-full bg-primary/10 text-primary hover:bg-primary/20", children: "Accept Suggestion" }, void 0, false, {
            fileName: "app/components/ai-suggestions.tsx",
            lineNumber: 243,
            columnNumber: 29
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { size: "sm", variant: "ghost", className: "w-8 p-0 text-muted-foreground hover:text-foreground", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(X, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/ai-suggestions.tsx",
            lineNumber: 247,
            columnNumber: 31
          }, this) }, void 0, false, {
...
_s(AiSuggestions, "MuSboQJhT9o0ZO6yC9I+w//qwi4=");
_c = AiSuggestions;
var _c;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\editor.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
var MenuButton = ({
  ...
  onClick,
  children
}) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { variant: isActive2 ? "secondary" : "ghost", size: "sm", className: "h-7 w-7 p-0", onClick, children }, void 0, false, {
...
function Editor2({
  ...
  _s2();
  const [showSuggestions, setShowSuggestions] = React3.useState(true);
  const editor = useEditor({
    extensions: [StarterKit.configure({
      heading: false
    }), Heading.configure({
      levels: [1, 2, 3]
    }), Highlight, TaskList, TaskItem.configure({
      nested: true
    ...
    onUpdate: ({
      ...
      const firstHeading = editor2.getJSON().content?.find((node) => node.type === "heading" && node.attrs.level === 1);
      if (firstHeading && onTitleChange) {
        const title2 = firstHeading.content?.[0]?.text || "Untitled";
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "relative flex gap-8", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "relative min-h-[500px] w-full max-w-2xl border-none sm:mb-[calc(20vh)]", children: [
      editor && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(BubbleMenu2, { className: cn("flex w-fit divide-x divide-border overflow-hidden rounded-lg border border-border bg-background shadow-md"), tippyOptions: {
        duration: 100
      }, editor, children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex items-center gap-1 px-1", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("heading", {
            level: 1
          }), onClick: () => editor.chain().focus().toggleHeading({
            level: 1
          }).run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Heading1, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 108,
            columnNumber: 17
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("heading", {
            ...
            level: 2
          }).run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Heading2, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 115,
            columnNumber: 17
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("heading", {
            ...
            level: 3
          }).run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Heading3, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 122,
            columnNumber: 17
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex items-center gap-1 px-1", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("bold"), onClick: () => editor.chain().focus().toggleBold().run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Bold, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 128,
            columnNumber: 17
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("italic"), onClick: () => editor.chain().focus().toggleItalic().run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Italic, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 131,
            columnNumber: 17
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("strike"), onClick: () => editor.chain().focus().toggleStrike().run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Strikethrough, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 134,
            columnNumber: 17
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex items-center gap-1 px-1", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("bulletList"), onClick: () => editor.chain().focus().toggleBulletList().run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(List, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 140,
            columnNumber: 17
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("orderedList"), onClick: () => editor.chain().focus().toggleOrderedList().run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ListOrdered, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 143,
            columnNumber: 17
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(MenuButton, { isActive: editor.isActive("blockquote"), onClick: () => editor.chain().focus().toggleBlockquote().run(), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Quote, { className: "h-4 w-4" }, void 0, false, {
            fileName: "app/components/editor.tsx",
            lineNumber: 146,
            columnNumber: 17
          }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(EditorContent, { editor }, void 0, false, {
        fileName: "app/components/editor.tsx",
        lineNumber: 150,
        columnNumber: 9
      }, this)
    ...
    showSuggestions && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "relative hidden w-96 xl:block", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "fixed right-8 w-96", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(AiSuggestions, { content: editor.getText() }, void 0, false, {
      fileName: "app/components/editor.tsx",
      lineNumber: 155,
      columnNumber: 13
    }, this) }, void 0, false, {
...
_s2(Editor2, "7s5krfzQBC0n0wuE+pY0ZOSRxSs=", false, function() {
  return [useEditor];
});
_c22 = Editor2;
var _c2;
...
@tiptap/react/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-V7UCO6WB.js.map
